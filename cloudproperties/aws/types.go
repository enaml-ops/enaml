...
type ResourcePool struct {
	...
	SplotOnDemandFallback bool          `yaml:"spot_ondemand_fallback,omitempty"` // [Boolean, optional]: Set to true to use an on demand instance if a spot instance is not available during VM creation. Defaults to false. Available in v36.
